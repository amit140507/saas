...
urlpatterns = [
    ...
    path('progress/', include('progress.checkins.urls')),
    path('progress/', include('progress.measurement.urls')),
    ...
    path('engagement/', include('engagement.followups.urls')),
    path('reports/', include('health.reports.urls')),
]

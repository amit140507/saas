        ...
        <div className="max-w-lg mx-auto py-10">
            ...
            <div className="flex items-center gap-3 mb-8">
                <div className="h-10 w-10 rounded-lg bg-red-100 dark:bg-red-900/30 flex items-center justify-center">
                    <LockIcon size={20} className="text-red-600 dark:text-red-400" />
                </div>
                <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-zinc-900 dark:text-zinc-100 bg-transparent shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 ${errors.old_password
                                        ...
                                        : "ring-zinc-300 dark:ring-zinc-700 focus:ring-red-600"
                                    }`}
                            />
                            <Toggle field="old" />
                        </div>
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 transition disabled:opacity-50"
                        >

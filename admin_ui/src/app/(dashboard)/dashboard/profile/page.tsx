                ...
                {isEditing ? (
                    <form onSubmit={handleUpdate} className="border-t border-zinc-200 dark:border-zinc-800 px-4 py-5 sm:p-6 space-y-6 transition-colors">
                        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                <label htmlFor="phone" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 transition-colors">
                                    Phone number
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd className="mt-1 text-sm text-zinc-900 dark:text-zinc-100 sm:mt-0 sm:col-span-2 transition-colors">
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-1.5 text-red-600 dark:text-red-400 hover:text-red-500 font-medium transition"
                                    >
                                        Change Password →
                                    </Link>
                                </dd>

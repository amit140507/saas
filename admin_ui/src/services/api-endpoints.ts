export const API_ENDPOINTS = {
    ...
    meal: {
        ...
        clientCurrentPlan: (clientId: string) => `meal/clients/${clientId}/plans/current/`,
        clientMealLogs: (clientId: string) => `meal/clients/${clientId}/meal-logs/`,
        clientMealAdherence: (clientId: string) => `meal/clients/${clientId}/meal-logs/adherence/`,

...
export default function Navbar() {
    ...
    return (
        <div
            ...
            className="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-end gap-x-4 border-b border-border bg-card px-4 pl-16 text-card-foreground shadow-sm transition-colors sm:gap-x-6 sm:px-6 lg:px-8"
        >
